...
<thinking>
I need to understand the user's request and determine the correct object (obj_code like TASK, PROJ, or USER), extract relevant fields (the attributes to display), and construct appropriate filters (conditions the data must satisfy based on the metadata provided).
</thinking>
